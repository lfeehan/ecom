...
--
-- Host: localhost
-- Generation Time: Apr 12, 2012 at 05:04 PM
...
('j30jot8uqdvc2vvc45mhlcgfv5', 'Peter', 'Armstrong', 'ballwyweelin', 'peteretep@gmail.com', 'card'),
...
(1006, 'j30jot8uqdvc2vvc45mhlcgfv5', '2012-04-12 15:43:53', 1020, 0);
...
(302, 'Wainman Rabitt Replacement - Rear Pigtai', 'Wainman Rabitt Replacement - Rear Pigtails', 8, 50, '', 'Wainman Rabbit replacement rear pigtails blue and red', 'Harnesses', '2012-03-09 14:22:37', 1, 0),
(303, 'Mystic Shadow Harness', 'Mystic Shadow Harness', 155, 20, '<strong>Available in:</strong><br />\nWHITE size large<br />\nBLACK size small<br />\nBLACK size medium</p>', 'The <strong>MYSTIC SHADOW</strong> harness. The Shadow is Mystics lightweight freestyle harness. The harness offers medium to high back support whilst maintaining a high range of body movement for freestyle tricks. This is the harness of choice for many of the worlds top freestyle kiteboarders such as Aaron Hadlow, Youri Zoon and Bruna Kajiya.<br />', 'Harnesses', '2012-04-12 16:01:24', 1, 1),
...
(403, 'Shred Ready Half-Cut Helmet', 'Shred Ready Half-Cut Helmet', 40, 20, 'Features:<br />\nABS molded shell<br />\nEPP liner &ndash; improved for better fit<br />\n\nHOG 2.0 Occipital Lock<br />\nInterchangeable color coded fitting pads (Sm, Md, Lg)<br />\nNylon straps attached with metal strap hangers<br />\nMeets and exceeds CE 1385 International Standard for Whitewater Helmets<br />', ' A new standard in helmet design has been set with the introduction of the SR Standard. Designed from the ground up to provide unparalleled performance.', 'Accessories', '2012-04-12 16:01:55', 5, 1),
